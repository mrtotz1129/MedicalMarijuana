	...
	<article class="white main z-depth-1">
		...
		<br>
				...
				<!-- Create Building Modal -->
				   <div id="createBuilding" class="modal modal-fixed-footer" style="width: 700px !important; border-radius: 10px;">
				    <form class="col s12 form" method="post" id="createEmpForm" action="{!! url('building') !!}" enctype="multipart/form-data">
				      ...
				      <h4 class="grey-text text-darken-1 center	thin">Create Building</h4>
		                    ...
		                    <div class="input-field col s12">
		                        <input name="strBuildingName" placeholder="Ex: Cojuangco" id="buidingName" type="text" class="validate tooltipped specialname" data-position="bottom" data-delay="30" data-tooltip="Ex: Cojuangco" pattern="^[a-zA-Z\-'`\s]{2,}$" minlength="2" required>
		                        <label for="buidingName" class="active">Building Name<span class="red-text"><b>*</b></span></label>
		                    </div>
		                    <div class="input-field col s12">
		                        <input name="strBuildingLocation" placeholder="Ex: Aquino" id="buildingLocation" type="text" class="validate tooltipped specialname" required data-position="bottom" data-delay="30" data-tooltip="Ex: Tondo, Manila" pattern="^[a-zA-Z\-'`\s]{2,}$" minlength="2">
				...
				<!-- Update Building Modal -->
				   <div id="updateBuilding" class="modal modal-fixed-footer" style="width: 700px !important; border-radius: 10px;">
				    <form class="col s12 form" method="post" id="createEmpForm" action="{!! url('building') !!}" enctype="multipart/form-data">
				    	<input type="hidden" name="_token" value="{!! csrf_token() !!}" />
				      <div class="modal-content" style="padding-bottom: 0px !important;">		   
				      <h4 class="grey-text text-darken-1 center	thin">Create Building</h4>
